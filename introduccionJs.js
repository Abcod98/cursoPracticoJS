...
// Utilizando arrays o objetos y una sola condicional
...
function suscripcionObj(suscripcion) {
    if (objSuscripciones[suscripcion]) {
        console.log(objSuscripciones[suscripcion]);
        return;
    }
    console.warn("Este tipo de suscripcion no existe")
}